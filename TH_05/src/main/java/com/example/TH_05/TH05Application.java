...
import com.example.TH_05.repository.ChungNhanDao;
import com.example.TH_05.repository.ChuyenBayDao;
import com.example.TH_05.repository.MayBayDao;
import com.example.TH_05.repository.NhanVienDao;

@SpringBootApplication
@org.springframework.transaction.annotation.Transactional
public class TH05Application {
	@Bean
...
//			28.	Tìm các chuyến bay có thể được thực hiện bởi tất cả các loại máy bay Boeing.
	...
	public static void main(String[] args) {
		SpringApplication.run(TH05Application.class, args);
	}
